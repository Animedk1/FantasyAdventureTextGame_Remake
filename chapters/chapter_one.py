...
def check_sword():
    ...
    time.sleep(0.3)
    typewriter("As you look up from staring down at the cold ground you realize the feeling of the bitter cold has dissipated... ")
    time.sleep(0.3)
    typewriter("and the world in front of you has changed.")
    time.sleep(0.3)
    ...
    time.sleep(0.3)
    typewriter("Before you can bring yourself to investigate you hear a powering voice coming from the sky")
    time.sleep(2)
    typewriter("Before you can collect yourself, you find that you are unable to move")
    clear_screen()
    ...
    time.sleep(0.5)
    typewriter("A plague exist throughout the isles from which you hail. One that has a spread so far as to reach within my domain")
    time.sleep(0.5)
    ...
    time.sleep(0.5)
    typewriter("I will bring you here again when you have proven ready")
    time.sleep(0.5)
    clear_screen()
    time.sleep(0.5)
    print_speaker("Mysterious Voice")
...
def equip_armor_scene_1():
    ...
    if choice =="a":
        typewriter("You've chosen to wear the armor")
        player["armored"] = True
        player["inventory"].append("Eldrich Plate Armour")
    elif choice == "b":
